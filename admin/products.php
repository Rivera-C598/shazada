...
<head>
    ...
    <title>Products - Shazada.com</title>
                ...
                <?php foreach ($products as $product): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="products.php?delete=<?php echo $product['product_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this product?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
